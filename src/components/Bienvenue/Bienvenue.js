                        ...
                        <Spring
                            ...
                            {(props) => (
                                <div className='quisommesnous-txt'>
                                    ...
                                    <p style={{ ...props }}>Jeune équipe de développeur passionné des nouvelles technologies, du développement informatique et du design. Nous mettons en œuvre notre savoir-faire en vous proposant tout types de prestations autour des sites internet et des applications mobile repoussant les limites de l’innovation, tout en étant à votre écoute et disponible peu importe votre fuseau horaire.<br/><br/> Effectivement, notre organisation est basée sur le travail à distance. Nous voyageons à travers le monde tout en pratiquant notre activité professionnelle. Nous vous accompagnerons dans vos projets, en vous proposants des services de la simple modification jusqu'à la création de site personnalisé, en passant par de la création d’identité ou la gestion de base de données.<br/><br/> Faites appel a nous dès aujourd'hui, nous mettons autant de passion dans nos projets que dans les vôtres !</p>
                                </div>
                            )}
                        </Spring>
                    )}
